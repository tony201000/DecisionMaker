			...
			<CardContent className="space-y-6">
				...
				<div className="grid grid-cols-3 gap-4 text-center">
					...
					<div>
						...
						<p className="text-2xl font-bold text-slate-900 dark:text-slate-100">
							{ratio === Number.POSITIVE_INFINITY ? "∞" : ratio.toFixed(1)}:1
						</p>
					</div>
				</div>
				...
				<div className="p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-800">
					<h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">
						Méthode de Seymour Schulich
					</h4>
					<p className="text-sm text-blue-700 dark:text-blue-300">
						"Si le score positif est au moins le double du score négatif, vous
						devriez procéder. Sinon, n'y allez pas ou réfléchissez-y à deux
						fois."
					</p>
				</div>
			</CardContent>
