...
export function DecisionChart({
	...
	const recommendation = useMemo(() => {
		if (totalScore === 0)
			return { text: "Aucune donnée", color: "text-gray-500" };
		if (positiveScore >= negativeScore * 2)
			return { text: "Favorable", color: "text-green-600" };
		if (negativeScore >= positiveScore * 2)
			return { text: "Défavorable", color: "text-red-600" };
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Visualisation semi-circulaire basée sur la méthode Schulich
				</CardDescription>
			</CardHeader>
			<CardContent>
