  ...
  return (
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">Ajoutez vos arguments et notez-les de -10 (très négatif) à +10 (très positif)</p>
      </CardHeader>
                          ...
                          return (
                            <Button
                              ...
                              className={`w-8 h-8 p-0 text-xs rounded-full ${getGradient(newWeight)} hover:scale-105 transition-all duration-200 ${
                                isCurrentWeight ? "opacity-100 ring-2 ring-primary scale-110 font-bold" : "opacity-70"
                              }`}
                              onClick={() => onUpdateArgumentWeight(argument.id, newWeight)}
                            >
                              {newWeight}
                            </Button>
                          )
