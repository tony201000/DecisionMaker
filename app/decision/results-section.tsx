        ...
        <CardContent className="space-y-4">
          ...
          {argumentsCount === 0 ? (
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 text-center">
              ...
              <div className="text-yellow-600 dark:text-yellow-300 text-sm mt-1">Ajoutez des arguments pour obtenir une recommandation</div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 text-center">
              <div className="text-blue-800 dark:text-blue-200 text-sm">
                Règle 2:1 de Schulich : Une décision est favorable si les arguments positifs sont au moins 2 fois supérieurs aux négatifs
              </div>
              {positiveScore >= negativeScore * 2 ? (
                <div className="text-green-700 dark:text-green-300 font-medium mt-2">✅ Décision recommandée</div>
              ) : negativeScore > positiveScore ? (
                <div className="text-red-700 dark:text-red-300 font-medium mt-2">❌ Décision non recommandée</div>
              ) : (
                <div className="text-orange-700 dark:text-orange-300 font-medium mt-2">⚠️ Décision incertaine</div>
              )}
            </div>
          )}
        </CardContent>
