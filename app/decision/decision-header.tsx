  ...
  return (
    <Card className="border-2 border-primary/20">
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">Commencez par décrire clairement la décision que vous devez prendre</p>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {!user && (
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
            <p className="text-sm text-blue-800 dark:text-blue-200">💡 Connectez-vous pour sauvegarder vos décisions et les retrouver plus tard</p>
          </div>
        )}
      </CardContent>
    </Card>
