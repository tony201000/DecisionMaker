...
export function AISuggestionsSection({ title, suggestions, loadingSuggestions, onGenerateSuggestions, onAddSuggestion }: AISuggestionsSectionProps) {
  ...
  return (
    <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
      <div className="flex items-center justify-between mb-3">
        <div>
          <h3 className="font-medium text-purple-800 dark:text-purple-200 flex items-center gap-2">🤖 Suggestions IA</h3>
      ...
      {suggestions.length > 0 && (
        <div className="space-y-3">
          <div className="text-sm font-medium text-purple-800 dark:text-purple-200">Suggestions générées ({suggestions.length}) :</div>
