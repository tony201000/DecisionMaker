...
const exampleArguments = [
  { positive: true, score: 8, text: "Opportunité de croissance" },
  { positive: true, score: 6, text: "Équipe motivée" },
  { positive: false, score: -5, text: "Investissement initial élevé" },
  { positive: false, score: -2, text: "Risque de marché" }
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-4xl mx-auto">
            Notre plateforme s'appuie sur la méthode éprouvée de Seymour Schulich, enrichie par l'intelligence artificielle pour vous aider à prendre
